    ...
    CRp.drawNode = function(context, node, drawOverlayInstead) {
        ...
        if (node._private.style['show-details'] === true)
        {
            ...
            context.shadowBlur = 10;
                ...
                context.beginPath();
                context.arc(node._private.position['x'], node._private.position['y'], node._private.style['width'].value + 3,
                        4.7, 9.1, 0);

                context.strokeStyle = "rgba(255,255,255,0)";
                context.lineTo(node._private.position['x'],
                    node._private.position['y']);
                context.fillStyle = 'rgb(122,212,249)';
                context.fill();
                context.closePath();
                context.stroke();
                ...
                context.lineTo(node._private.position['x'],
                    node._private.position['y']);
                context.fillStyle = 'rgb(154,212,147)';
                context.fill();
                context.closePath();
                context.stroke();
                ...
                context.lineTo(node._private.position['x'],
                    node._private.position['y']);
                context.fillStyle = 'rgb(166,143,192)';
                context.fill();
                context.closePath();
                context.stroke();
